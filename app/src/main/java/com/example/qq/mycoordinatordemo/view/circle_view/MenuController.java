...
public class MenuController {
    ...
    private HashMap<CircleMenuButton,MenuButtonPoint> mButtonsPosition = new HashMap<>();
    ...
    public MenuController(ControllerListener mListener) {
    ...
    public void calculateButtonsVertices(float radius,int startAngle,int circleWidth, int circleHeight, int centerX, int centerY){
        ...
        for (int i = 0; i < childCount;i++){
            ...
            mButtonsPosition.put(button,new MenuButtonPoint(left,top,currentAngle));
    ...
    private void startCollapseAnimation(){
        ...
        for (int i = 0;i < getButtonsCount();i++){
            final CircleMenuButton button = mButtons.get(i);
            MenuButtonPoint buttonPoint = mButtonsPosition.get(button);
            float startPositionX = buttonPoint.x;
            float endPositionX = mCenterPositionX;
            float startPositionY = buttonPoint.y;
    ...
    private void startExpandAnimation() {
        ...
        for (int i = 0; i < getButtonsCount(); i++) {
            final CircleMenuButton button = mButtons.get(i);
            MenuButtonPoint buttonPosition = mButtonsPosition.get(button);
    ...
    public MenuButtonPoint getButtonsPoint(CircleMenuButton menuButton){
        return mButtonsPosition.get(menuButton);
    }
}
