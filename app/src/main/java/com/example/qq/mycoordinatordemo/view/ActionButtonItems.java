...
public class ActionButtonItems extends View implements ValueAnimator.AnimatorUpdateListener{
    ...
    public ActionButtonItems(Context context, int tag, int circleRadius, int dimens, int expandDirect,int normalColor, int pressColor, boolean isSwitchButton) {
        this(context);
        this.tag = tag;
    ...
    public void startSpringAnimation(long time,float startValue,float endValue){
        ValueAnimator valueAnimator = ValueAnimator.ofObject(new com.example.qq.mycoordinatordemo.view.FloatEvaluator(time,startValue,endValue),startValue,endValue);
