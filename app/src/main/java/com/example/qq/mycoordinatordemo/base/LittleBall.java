package com.example.qq.mycoordinatordemo.base;
...
public class LittleBall {
    ...
    private int mView_endX,mView_endY;
    ...
    public void init(){
        this.mStart_X = ViewUtils.randomIntPositive(mView_endX + mView_w,mView_endX);
        this.mStart_Y = ViewUtils.randomIntPositive(mView_endY + mView_h,mView_endY);
        this.mEnd_X = ViewUtils.randomIntPositive(mView_endX + mView_w,mView_endX - mView_w);
        this.mEnd_Y = mView_endY + mView_h;
        this.mRadius = ViewUtils.randomIntPositive(12,4);
